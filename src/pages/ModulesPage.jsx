    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8 min-h-[80vh]">
            <div className="mb-8">
                ...
                <p className="text-slate-500 dark:text-slate-400">Complete modules to earn XP and secure your business.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {modules.map((module) => {
                    ...
                    return (
                        <div key={module.id} className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-md transition p-6 flex flex-col">
                            <div className="flex justify-between items-start mb-4">
                                <div className="p-3 bg-slate-100 dark:bg-slate-700 rounded-lg">
                                    {module.icon}
                                </div>
                                {isCompleted && <CheckCircle className="w-6 h-6 text-green-500 dark:text-green-400" />}
                            </div>
